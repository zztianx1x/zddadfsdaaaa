...
#### 本项目旨在为不会翻墙的网友提供自由的新闻资讯。面对TG的暴力与谎言的组合拳，我们无法对抗暴力，但能破除谎言。（若通过微信打开下面链接时有安全提示，敬请忽略，本页面并无不安全内容，只是被列为“违法违规则”，请使用页尾提供的方法继续访问）
...
##### 使用微信、支付宝等二维码工具 扫一扫获取固定网址, 点击右上角"...", 在弹出菜单中点击“在浏览器打开”； 若网页被举报禁止访问，请点击“恢复申请访问”，将链接复制并粘贴到浏览器中打开（请不要使用QQ或360浏览器，因为隐私得不到保障）
